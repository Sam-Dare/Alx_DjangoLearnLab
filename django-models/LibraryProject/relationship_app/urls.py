...
urlpatterns = [
    ...
    path('books/add/', views.add_book, name='add_book'),  # URL for adding books
    path('books/<int:pk>/edit/', views.edit_book, name='edit_book'),  # URL for editing books
    path('books/<int:pk>/delete/', views.delete_book, name='delete_book'),  # URL for deleting books
